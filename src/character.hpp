...
class Character : public Shared
{
	public:
		...
		STD_TR1::array<int, 15> paperdoll;
	...
	SCRIPT_REGISTER_REF(Character)
		...
		SCRIPT_REGISTER_VARIABLE("SitState", sitting);
		...
		SCRIPT_REGISTER_FUNCTION("void Sit(SitState sit_type)", Sit);
...
struct CharacterEvent : public Shared
{
	...
	SCRIPT_REGISTER_REF_DF(CharacterEvent)
		...
		SCRIPT_REGISTER_VARIABLE("SitState", sit_state);
	SCRIPT_REGISTER_END()
};
