...
BIN = eoserv
OBJ = obj/config.o obj/database.o obj/eoclient.o obj/eodata.o obj/eoserv.o obj/handlers.o obj/hash.o obj/main.o obj/packet.o obj/sha256.o obj/socket.o obj/util.o
